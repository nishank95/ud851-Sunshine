...
//      TODO (8) Display the summary that you created above
        ...
        String weatherDescription = SunshineWeatherUtils.getStringForWeatherCondition(mContext,weather_id);


        double lowinCelsius=mCursor.getInt(MainActivity.INDEX_WEATHER_MIN_TEMP);
        double highinCelsius=mCursor.getInt(MainActivity.INDEX_WEATHER_MAX_TEMP);

        String highAndLowTemprature= SunshineWeatherUtils.formatHighLows(mContext,highinCelsius,lowinCelsius);

        String weatherSummary = dateString + " - " + weatherDescription + " - " + highAndLowTemprature;
