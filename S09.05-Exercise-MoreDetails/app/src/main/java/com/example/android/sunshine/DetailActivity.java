...
//      TODO (13) Find each of the TextViews by ID
        mweatherDate = (TextView) findViewById(R.id.weatherDate);
        mweatherDescription = (TextView) findViewById(R.id.weatherDesc);
        mweatherMaxTemp = (TextView) findViewById(R.id.weatherMaxTemp);
        mweatherMinTemp = (TextView) findViewById(R.id.weatherMinTemp);
        mweatherHumidity = (TextView) findViewById(R.id.weatherHumidity);
        mweatherWind = (TextView) findViewById(R.id.weatherWind);
        mweatherPressure = (TextView) findViewById(R.id.weatherPressure);
...
//  TODO (24) Override onLoadFinished
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        mweatherMaxTemp.setText(highString);

        double lowInCelsius = data.getDouble(INDEX_WEATHER_MIN_TEMP);
        String lowString = SunshineWeatherUtils.formatTemperature(this, lowInCelsius);

        mweatherMinTemp.setText(lowString);
        ...
        mForecastSummary = String.format("%s - %s - %s/%s",weatherDate,weatherDesc,highString,lowString);
    }
